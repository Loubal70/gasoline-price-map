    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __("Le :attribute doit être composé d'au moins :length caractères et contenir au moins un caractère majuscule.", [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __("Le :attribute doit être composé d'au moins :length caractères et contenir au moins un nombre.", [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireSpecialCharacter
                && ! $this->requireUppercase
                && ! $this->requireNumeric:
                return __("Le :attribute doit être composé d'au moins :length caractères et contenir au moins un caractère spécial.", [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __("Le :attribute doit être composé d'au moins :length caractères et contenir au moins un caractère majuscule et un chiffre.", [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireSpecialCharacter
                && ! $this->requireNumeric:
                return __("Le :attribute doit être composé d'au moins :length caractères et contenir au moins un caractère majuscule et un caractère spécial.", [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && $this->requireSpecialCharacter:
                return __('Le :attribute doit comporter au moins :length caractères et contenir au moins un caractère majuscule, un chiffre et un caractère spécial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                && $this->requireSpecialCharacter
                && ! $this->requireUppercase:
                return __('Le :attribute doit comporter au moins :length caractères et contiennent au moins un caractère spécial et un chiffre.', [
                    'length' => $this->length,
                ]);

            default:
                return __('Le :attribute doit être au minimum de  :length caractères.', [
                    'length' => $this->length,
                ]);
        }
    }
